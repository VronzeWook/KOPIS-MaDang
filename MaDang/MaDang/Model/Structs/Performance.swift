...
struct Performance {
    ...
    static var performList: [Performance] =  [Performance(id: UUID().uuidString, title: "the Sth a35135135sdg", genre: .Musical, startDate: Date(), endDate: Date(), showtime: "오늘부터 내일까지", ageLimit: "6세 이상", salesVolume: 1253, area:"@@ performance center",posterUrlList: [], reviewList: [], actorList: [], likeCount: 123, starRating: 4.53),
